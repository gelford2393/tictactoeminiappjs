...
function switchTurn() {
  ...
  // Else if document.turn is 'X'
  else if (document.turn == playerX.name) {
    // Set document.turn to 'O'
    document.turn = playerY.name;
    ...
    document.querySelectorAll(".square").style.color = "#28a745";
    // Else...
  } else {
    ...
    setTurnMessage("It is " + document.turn + "'s turn.");
    // Set document.turn 'color:' to '#;' (#de3241 = 'danger' (red) in Bootstrap 4.0)
    document.getElementById("turnMessage").style.color = "#de3241";
    document.querySelectorAll(".square").style.color = "#16a2b8";
  }
}
